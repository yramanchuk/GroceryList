...
class SuggestedListManager: NSObject
{
    ...
    {
        self.suggestedItems.append(ShoppingItem(name: "Cookies", imageName: "Cookies", unitPrice: "$2.95", quantity: 1, units: "13.3 oz", description: "Chocolate"))
        ...
        self.suggestedItems.append(ShoppingItem(name: "Cantaloupe", imageName: "Cantaloupe", unitPrice: "$0.63", quantity: 1, units: "1 lb", description: "Organic"))
        ...
        self.suggestedItems.append(ShoppingItem(name: "Figs", imageName: "Figs", unitPrice: "$4.09", quantity: 1, units: "5 oz", description: "Organic"))
        ...
        self.suggestedItems.append(ShoppingItem(name: "Hot Dog Buns", imageName: "HotDogBuns", unitPrice: "$3.29", quantity: 1, units: "8 ct", description: "Enriched Buns"))
